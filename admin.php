    ...
    if (isset($_POST["selected_date"])){
        ...
        if (isset($_POST["selected_type"])) {
            ...
            if (strcmp($selected_type, "request date")==0) {
                ...
                $query = "SELECT * FROM (request JOIN register ON request.customer_number = register.customer_number) WHERE preferredDate = '$selected_date' ORDER BY suburb DESC,receiverState DESC,receiverSuburb DESC";
            } else {
